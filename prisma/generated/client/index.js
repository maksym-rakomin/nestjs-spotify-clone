...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/maksymrakomin/sites/nestjs-course/n-fundamentals-pro/prisma/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/maksymrakomin/sites/nestjs-course/n-fundamentals-pro/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://maksymrakomin:1234@localhost:5432/prisma-api?schema=public"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Video {\n  id    Int    @id @default(autoincrement())\n  title String\n}\n",
  "inlineSchemaHash": "7de51156641d42a16be3fe778263950db91c9827272077612e698334e0828e9a",
  "copyEngine": true
}
