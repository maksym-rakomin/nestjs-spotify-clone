...
export class Init1743927477827 implements MigrationInterface {
    name = 'Init1743927477827'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "artists" ("id" SERIAL NOT NULL, "user_id" integer, CONSTRAINT "REL_b6ae1e521cfeccade55e889f3d" UNIQUE ("user_id"), CONSTRAINT "PK_09b823d4607d2675dc4ffa82261" PRIMARY KEY ("id"))`);
